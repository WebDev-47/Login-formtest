...
const Loginform = () => {
  ...
  const HandleUsernameinput = (e) => {
    setInputdata({...setInputed, Username: e.target.value});
  };

  const HandlePasswordinput = (e) => {
    setInputdata({...setInputed, Password: e.target.value});
  };
  ...
  return (
    <div className="Log h-screen flex justify-center items-center">
      {Inputed ? (
<div className=" backdrop-blur-md border bg-green-500/20 border-green-500 h-[3rem] text-white font-bold
